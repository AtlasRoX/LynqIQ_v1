...
import { Loader2, Bell, Trash2, CheckCircle, AlertTriangle, AlertCircle, Info, Filter } from "lucide-react"
...
export default function NotificationsPage() {
  ...
  const unreadCount = filteredAnomalies.length
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-accent/10 rounded-lg">
            ...
            <span className="font-semibold">{unreadCount} Alerts</span>
          </div>
        </div>
        <DateFilter />
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-2 flex-wrap items-center">
            ...
            {dismissedCount > 0 && (
              <Button size="sm" variant="ghost" onClick={clearAllDismissed} className="ml-auto">
