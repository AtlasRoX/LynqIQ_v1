...
import { ColorThemeSelector } from "@/components/dashboard/color-theme-selector"
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">This name will appear on your PDF reports.</p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="p-4 bg-muted/50 rounded-lg border">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch checked={settings.autoBackup} onCheckedChange={() => handleSwitchChange("autoBackup")} />
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch checked={settings.darkMode} onCheckedChange={() => handleSwitchChange("darkMode")} />
          </div>
        </CardContent>
      </Card>
