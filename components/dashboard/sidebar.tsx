  ...
  return (
    <aside
      className={cn(
        ...
        // Use w-20 when collapsed (w-16 is often too tight for icons)
    ...
    >
      ...
      <nav
        className={cn(
          ...
          isCollapsed && 'px-2' // Use tighter padding when collapsed
        )}
      >
        {navGroups.map((group) => (
          <div key={group.title}>
            {/* Show a separator when collapsed, or the title when expanded */}
            {isCollapsed ? (
      ...
      <div
        className={cn(
          ...
          isCollapsed && 'p-2' // Tighter padding
        )}
      >
        {user && (
          <div
            className={cn(
              'px-2 py-2 bg-accent rounded-lg',
              isCollapsed && 'hidden' // Hide user email block
            )}
          >
